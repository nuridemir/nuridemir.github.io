...
const CardComponents = (props) => {
    return (
        <div
            ...
            <figure>
                <img className="w-full h-auto rounded-xl" src={props.img}
            ...
            <p className="mt-2 text-2xl font-semibold text-white">{props.title}</p>
            <p className="py-2">
                {props.desc}
            </p>
            <p className='text-sm text-blue-300 hover:text-blue-400 duration-300'>
                <a href={`https://${props.source}`} target="_blank">{props.source}</a>
            </p>
